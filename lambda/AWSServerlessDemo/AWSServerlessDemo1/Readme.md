...
Execute unit tests
```
    cd "AWSServerlessDemo1/test/AWSServerlessDemo1.Tests"
    dotnet test
```

Deploy application
```
    cd "AWSServerlessDemo1/src/AWSServerlessDemo1"
    dotnet lambda deploy-serverless
```

dotnet publish -c Release

AWSServerlessDemo1::AWSServerlessDemo1.LambdaEntryPoint::FunctionHandlerAsync

create an api gateway

create a resource as procy

create a methos as proxy

deploy the configuration to a stage

remeber enable cors in the application and api gateway
